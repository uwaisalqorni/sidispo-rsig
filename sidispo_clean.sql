...
INSERT IGNORE INTO users (id, nip, nama_lengkap, email, password_hash, jabatan, jabatan_id, role) VALUES (1, '0000', 'Superadmin', 'admin@rsud.go.id', 'dummyhash', 'Admin', 6, 'ADMIN');
